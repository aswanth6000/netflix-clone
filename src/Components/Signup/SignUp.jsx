    ...
    <div>
        ...
        <form className="w-full md:w-4/12 absolute p-12 bg-gray-900 my-14 mx-auto right-0 left-0 text-white bg-opacity-80" onSubmit={(event)=> event.preventDefault()}>
            <h1 className="font-bold text-3xl py-4"> Sign Up</h1>
             <input type="text" className="p-4 my-4 w-full bg-gray-700 rounded-md"  placeholder="Full name" value={value.name} onChange={handleChange} /> 
            <input type="text" className="p-4 my-4 w-full bg-gray-700 rounded-md" placeholder="Email address" value={value.email} onChange={handleChange} />
            <input type="password" className="p-4 my-4 w-full bg-gray-700 rounded-md border-none focus:border border-blue-700" value={value.password}  placeholder="Password" onChange={handleChange} />
